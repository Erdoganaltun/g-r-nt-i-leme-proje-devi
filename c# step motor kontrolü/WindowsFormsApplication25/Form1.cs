...
namespace WindowsFormsApplication25
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (x_koordinat < 200 && y_koordinat < 500)
            {
                label5.Text = "motor sola doğru dönüyor";
                seriPort.Write("1");

            }
            else if (x_koordinat < 425 && y_koordinat < 500)
            {
                label5.Text = "motor duruyor. ";
                seriPort.Write("2");
            }
            else if (x_koordinat < 650 && y_koordinat < 500)
            {
                label5.Text = "motor sağa doğru dönüyor ";
                seriPort.Write("0");
            }
